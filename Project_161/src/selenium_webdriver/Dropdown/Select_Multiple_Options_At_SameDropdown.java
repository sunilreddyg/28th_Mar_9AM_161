...
public class Select_Multiple_Options_At_SameDropdown 
{
	...
	public static void main(String[] args) 
	{
		...
		if(flag1==true)
		{
			...
			Multiple_Selection.selectByIndex(8);
				...
				if(Count==3)
				{
					System.out.println("Testpass ;--> selecton Count is => "+Count);
				}
				else
				{
					System.out.println("Testfail:--> Selected count is => "+Count);
				}
