...
public class Visibility_of_Element_Located 
{
	...
	public static void main(String[] args)
	{
		...
		//Set timeout until expected element visible at webpage
		WebElement password_EB=wait.until(ExpectedConditions.visibilityOfElementLocated(Password_locator));
		password_EB.clear();
		password_EB.sendKeys("Hello12345");
		
		System.out.println("password Element is visible");
